...
class mcollective::server::config {
  ...
  file { "${mcollective::configdir}/policies":
    ensure => 'directory',
    owner  => 'root',
    group  => '0',
    mode   => '0700',
  ...
  if $mcollective::middleware_ssl or $mcollective::securityprovider == 'ssl' {
    file { "${mcollective::configdir}/ca.pem":
      owner  => 'root',
      group  => '0',
      mode   => '0444',
    ...
    file { "${mcollective::configdir}/server_public.pem":
      owner  => 'root',
      group  => '0',
      mode   => '0444',
    ...
    file { "${mcollective::configdir}/server_private.pem":
      owner  => 'root',
      group  => '0',
      mode   => '0400',
